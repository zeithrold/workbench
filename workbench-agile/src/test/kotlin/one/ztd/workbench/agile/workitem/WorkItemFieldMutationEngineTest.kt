...
import one.ztd.workbench.agile.workitem.template.TemplateValueExpression
                  ...
                  TransitionFieldSpec(
                    ...
                    value =
                      TemplateValueExpression.RelativeDate(
                        amount = 3,
                        unit =
                          one.ztd.workbench.agile.workitem.template.TemplateRelativeDateUnit.DAY,
                        direction =
                          one.ztd.workbench.agile.workitem.template.TemplateDateDirection.FUTURE,
                        anchor = "date.today",
                      ),
                  ),
              ),
    ...
    "reconcileTransitionComment uses template default when user comment absent" {
      val body =
        engine.reconcileTransitionComment(
          spec =
            one.ztd.workbench.agile.workitem.template.CommentFieldSpec(
              participation = FieldParticipation.OPTIONAL,
