...
class WorkItemTransitionValidator(
  ...
  ): one.ztd.workbench.agile.workitem.access.WorkItemAccessEvaluationContext {
  ...
  suspend fun requireTransitionPermission(
    ...
    transition: WorkflowTransitionRecord,
    evaluationContext: one.ztd.workbench.agile.workitem.access.WorkItemAccessEvaluationContext,
  ) {
    if (
