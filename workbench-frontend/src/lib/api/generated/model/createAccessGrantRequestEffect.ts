...
export type CreateAccessGrantRequestEffect = typeof CreateAccessGrantRequestEffect[keyof typeof CreateAccessGrantRequestEffect];


export const CreateAccessGrantRequestEffect = {
  ALLOW: 'ALLOW',
  DENY: 'DENY',
} as const;
