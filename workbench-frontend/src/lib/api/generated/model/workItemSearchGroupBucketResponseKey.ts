...
import type { WorkItemSearchGroupBucketResponseKeyEntriesItem } from './workItemSearchGroupBucketResponseKeyEntriesItem';

export type WorkItemSearchGroupBucketResponseKey = {
  values?: JsonElement[];
  empty?: boolean;
  size?: number;
  entries?: WorkItemSearchGroupBucketResponseKeyEntriesItem[];
  keys?: string[];
  [key: string]: unknown;
};
