...
import type { PropertyDefinitionResponseSearchConfigEntriesItem } from './propertyDefinitionResponseSearchConfigEntriesItem';

export type PropertyDefinitionResponseSearchConfig = {
  values?: JsonElement[];
  empty?: boolean;
  size?: number;
  entries?: PropertyDefinitionResponseSearchConfigEntriesItem[];
  keys?: string[];
  [key: string]: unknown;
};
