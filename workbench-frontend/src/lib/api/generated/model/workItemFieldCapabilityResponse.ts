 ...
 */
import type { WorkItemFieldCapabilityResponseState } from './workItemFieldCapabilityResponseState';

export interface WorkItemFieldCapabilityResponse {
  state: WorkItemFieldCapabilityResponseState;
  reason?: string;
}
