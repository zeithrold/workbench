 ...
 */
import type { WorkItemFieldCapabilityResponse } from './workItemFieldCapabilityResponse';

export type WorkItemResponseFieldCapabilities = {[key: string]: WorkItemFieldCapabilityResponse};
