 ...
 */
import type { ManagementNavigationResponseTenantContextStatus } from './managementNavigationResponseTenantContextStatus';
import type { NavigationItemResponse } from './navigationItemResponse';

export interface ManagementNavigationResponse {
