 ...
 */
import type { WorkItemPropertyPresentationResponse } from './workItemPropertyPresentationResponse';

export type WorkItemResponseProperties = {[key: string]: WorkItemPropertyPresentationResponse};
