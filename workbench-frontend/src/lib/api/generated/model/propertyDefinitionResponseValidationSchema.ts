...
import type { PropertyDefinitionResponseValidationSchemaEntriesItem } from './propertyDefinitionResponseValidationSchemaEntriesItem';

export type PropertyDefinitionResponseValidationSchema = {
  values?: JsonElement[];
  empty?: boolean;
  size?: number;
  entries?: PropertyDefinitionResponseValidationSchemaEntriesItem[];
  keys?: string[];
  [key: string]: unknown;
};
