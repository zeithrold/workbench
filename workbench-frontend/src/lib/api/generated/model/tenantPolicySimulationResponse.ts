 ...
 */
import type { TenantPolicySimulationRuleResponse } from './tenantPolicySimulationRuleResponse';

export interface TenantPolicySimulationResponse {
  decision?: string;
  reason?: string;
  rules?: TenantPolicySimulationRuleResponse[];
}
