 ...
 */
import type { WorkbenchWarningItem } from './workbenchWarningItem';

/**
 * Structured warning envelope returned in the X-Workbench-Warning response header.
 */
export interface WorkbenchWarningEnvelope {
  version?: number;
  items?: WorkbenchWarningItem[];
}
