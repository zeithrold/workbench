 ...
 */
import type { CreateAccessGrantRequestEffect } from './createAccessGrantRequestEffect';
import type { CreateAccessGrantRequestScope } from './createAccessGrantRequestScope';

export interface CreateAccessGrantRequest {
  /** Grant scope. */
  scope?: CreateAccessGrantRequestScope;
  /** @minLength 1 */
  userId: string;
  /** @minLength 1 */
  action: string;
  ...
  effect?: CreateAccessGrantRequestEffect;
  projectId?: string;
}
