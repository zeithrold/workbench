...
import type { WorkItemAccessRuleResponseConditionEntriesItem } from './workItemAccessRuleResponseConditionEntriesItem';

export type WorkItemAccessRuleResponseCondition = {
  values?: JsonElement[];
  empty?: boolean;
  size?: number;
  entries?: WorkItemAccessRuleResponseConditionEntriesItem[];
  keys?: string[];
  [key: string]: unknown;
};
