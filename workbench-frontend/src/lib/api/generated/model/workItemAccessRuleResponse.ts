 ...
 */
import type { WorkItemAccessRuleResponseCondition } from './workItemAccessRuleResponseCondition';

export interface WorkItemAccessRuleResponse {
  id?: string;
  subjectType?: string;
  ...
  fieldKey?: string;
  effect?: string;
  condition?: WorkItemAccessRuleResponseCondition;
  rank?: number;
}
