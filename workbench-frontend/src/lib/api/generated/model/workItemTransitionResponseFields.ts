...
import type { WorkItemTransitionResponseFieldsEntriesItem } from './workItemTransitionResponseFieldsEntriesItem';

export type WorkItemTransitionResponseFields = {
  values?: JsonElement[];
  empty?: boolean;
  size?: number;
  entries?: WorkItemTransitionResponseFieldsEntriesItem[];
  keys?: string[];
  [key: string]: unknown;
};
