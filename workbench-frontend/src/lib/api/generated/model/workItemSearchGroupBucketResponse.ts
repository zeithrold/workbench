...
import type { WorkItemSearchGroupBucketResponseKey } from './workItemSearchGroupBucketResponseKey';

export interface WorkItemSearchGroupBucketResponse {
  key: WorkItemSearchGroupBucketResponseKey;
  label: WorkItemGroupLabelMessageResponse | WorkItemGroupLabelTextResponse;
  count: number;
}
