...
import type { WorkflowTransitionResponseFieldsEntriesItem } from './workflowTransitionResponseFieldsEntriesItem';

export type WorkflowTransitionResponseFields = {
  values?: JsonElement[];
  empty?: boolean;
  size?: number;
  entries?: WorkflowTransitionResponseFieldsEntriesItem[];
  keys?: string[];
  [key: string]: unknown;
};
