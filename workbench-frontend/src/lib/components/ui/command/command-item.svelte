...
>
  {@render children?.()}
  <CheckIcon class='cn-command-item-indicator ml-auto size-3.5 opacity-0 group-has-[[data-slot=command-shortcut]]/command-item:hidden group-data-[checked=true]/command-item:opacity-100' />
</CommandPrimitive.Item>
