...
import one.ztd.workbench.agile.sprint.CreateSprintCloseOperationCommand
...
import one.ztd.workbench.agile.sprint.SprintCloseRetryRequest
import one.ztd.workbench.agile.sprint.SprintCloseSuccessRequest
import one.ztd.workbench.agile.sprint.events.SprintCloseFailedEvent
import one.ztd.workbench.agile.sprint.events.SprintClosedEvent
import one.ztd.workbench.agile.sprint.events.SprintDomainEvents
...
import one.ztd.workbench.data.persistence.postgres.workitem.SprintCloseOperationsTable
  ...
  override suspend fun createAndMarkClosing(
    ...
    suspendTransaction(db = database) {
      ...
      outbox.append(
        ...
        key = sprintApiId,
        payload =
          one.ztd.workbench.agile.sprint.events.SprintCloseRequestedEvent(
      ...
      val operation =
        SprintCloseOperationsTable.join(
          ...
          ?: throw one.ztd.workbench.kernel.common.errors.ResourceNotFoundException(
            one.ztd.workbench.kernel.common.errors.WorkbenchErrorCode
              .SPRINT_CLOSE_OPERATION_NOT_FOUND
          )
      if (operation.status != SprintCloseOperationStatus.FAILED) {
        throw one.ztd.workbench.kernel.common.errors.InvalidRequestException(
          one.ztd.workbench.kernel.common.errors.WorkbenchErrorCode.SPRINT_CLOSE_OPERATION_CONFLICT
        )
      }
      SprintCloseOperationsTable.update({
