...
import one.ztd.workbench.agile.workitem.WorkItemTimelineRepository
...
import one.ztd.workbench.data.persistence.postgres.workitem.WorkItemTimelineEntriesTable
...
class ExposedWorkItemTimelineRepository(
  ...
  private fun hydrateCommentEntry(
    event: one.ztd.workbench.agile.workitem.stream.WorkItemEventRecord,
    tenantId: UUID,
...
private fun one.ztd.workbench.agile.workitem.stream.WorkItemEventRecord.commentApiId(): String? =
