package one.ztd.workbench.data.persistence.postgres.project
...
object ProjectsTable : Table("projects") {
  ...
  val nonMemberVisibility = text("non_member_visibility")
  val nonMemberJoinPolicy = text("non_member_join_policy")
