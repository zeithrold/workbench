...
import kotlinx.serialization.json.jsonObject
import one.ztd.workbench.agile.workitem.WorkItemAccessRulePresentation
...
data class WorkItemAttachmentUploadSessionResponse(
  ...
  companion object {
    fun from(session: one.ztd.workbench.agile.workitem.WorkItemAttachmentUploadSession) =
