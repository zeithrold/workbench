...
object OpenApiExamples {
  ...
  const val INVALID_REQUEST =
    """
    {
      "type": "https://api.ztd.one/workbench/problems/invalid-request",
  ...
  const val AUTHENTICATION_FAILED =
    """
    {
      "type": "https://api.ztd.one/workbench/problems/authentication-failed",
  ...
  const val RESOURCE_NOT_FOUND =
    """
    {
      "type": "https://api.ztd.one/workbench/problems/resource-not-found",
  ...
  const val TENANT_NOT_SELECTED =
    """
    {
      "type": "https://api.ztd.one/workbench/problems/tenant-not-selected",
