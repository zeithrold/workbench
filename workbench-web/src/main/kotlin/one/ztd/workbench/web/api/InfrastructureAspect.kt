...
import one.ztd.workbench.web.api.context.ScopedRequestContext
...
class InfrastructureAspect(
  ...
  @Around("@annotation(one.ztd.workbench.web.api.Audit)")
  ...
  @Around("@annotation(one.ztd.workbench.web.api.PublishEvent)")
  ...
  @Around("@annotation(one.ztd.workbench.web.api.RequirePermission)")
