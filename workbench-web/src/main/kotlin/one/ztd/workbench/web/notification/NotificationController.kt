package one.ztd.workbench.web.notification
...
import one.ztd.workbench.notification.NotificationView
...
data class NotificationPreferenceResponse(
  ...
  companion object {
    fun from(record: one.ztd.workbench.notification.NotificationPreferenceRecord) =
      NotificationPreferenceResponse(
