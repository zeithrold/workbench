...
import ink.doa.workbench.identity.model.TenantAdminAssignment.EmailInviteAssignment
import ink.doa.workbench.identity.model.TenantAdminAssignment.SelfAssignment
import ink.doa.workbench.identity.model.TenantAdminAssignment.UserAssignment
...
import ink.doa.workbench.tenant.tenantconfig.model.AuthSessionTenantConfig
  ...
  StringSpec({
    ...
    "work item mutation commands store actor and field metadata" {
      ...
      UpdateWorkItemCommentCommand(
          ...
          actorUserId = userId,
          body =
            ink.doa.workbench.agile.workitem.richtext.RichTextProcessor.fromPlainText("Edited")!!,
        )
        .body shouldBe
        ink.doa.workbench.agile.workitem.richtext.RichTextProcessor.fromPlainText("Edited")
