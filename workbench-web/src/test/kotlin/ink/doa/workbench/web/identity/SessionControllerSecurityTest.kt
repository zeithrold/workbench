...
class SessionControllerSecurityTest(@Autowired private val mockMvc: MockMvc) {
  ...
  class TestBeans {
    ...
    @Bean
    fun projectOperationalGuard(): ink.doa.workbench.agile.project.ProjectOperationalGuard =
      ink.doa.workbench.agile.project.ProjectOperationalGuard(UnusedProjectRepository)
