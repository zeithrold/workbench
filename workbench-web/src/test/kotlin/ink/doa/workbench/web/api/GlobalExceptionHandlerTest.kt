...
import ink.doa.workbench.kernel.common.errors.InfrastructureUnavailableException
...
import ink.doa.workbench.web.instance.CreateTenantRequest
...
class GlobalExceptionHandlerTest :
  StringSpec({
    ...
    "default API version uses date header format" {
      ApiVersion.Default.value shouldBe "2026-07-13"
