  ...
  StringSpec({
    ...
    "work item comment response maps record fields" {
      ...
      WorkItemCommentResponse.from(record).body.toDomain() shouldBe
        one.ztd.workbench.agile.workitem.richtext.RichTextProcessor.fromPlainText("Looks good")
    }
    ...
    "comment request types store body text" {
      val created =
        one.ztd.workbench.agile.workitem.richtext.RichTextProcessor.fromPlainText("Created")!!
      val updated =
        one.ztd.workbench.agile.workitem.richtext.RichTextProcessor.fromPlainText("Updated")!!
