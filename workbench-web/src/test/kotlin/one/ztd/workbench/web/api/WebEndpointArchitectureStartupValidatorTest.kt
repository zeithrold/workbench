...
import one.ztd.workbench.web.admin.AdminUserController
...
import one.ztd.workbench.web.identity.BearerTokenAuthController
import one.ztd.workbench.web.identity.FederatedAuthController
import one.ztd.workbench.web.identity.LoginDiscoveryController
import one.ztd.workbench.web.identity.MagicLinkAuthController
import one.ztd.workbench.web.identity.SessionAuthController
import one.ztd.workbench.web.identity.SessionController
import one.ztd.workbench.web.instance.InstanceSetupController
import one.ztd.workbench.web.instance.TenantAdminController
import one.ztd.workbench.web.invitation.InvitationController
import one.ztd.workbench.web.manage.ManagePermissionBindingController
import one.ztd.workbench.web.manage.ManagePermissionGroupController
import one.ztd.workbench.web.manage.ManagePermissionPolicyController
import one.ztd.workbench.web.project.ProjectController
import one.ztd.workbench.web.project.ProjectMemberController
import one.ztd.workbench.web.workitem.ProjectWorkItemCommentController
import one.ztd.workbench.web.workitem.ProjectWorkItemConfigurationController
import one.ztd.workbench.web.workitem.ProjectWorkItemController
import one.ztd.workbench.web.workitem.WorkItemIssueTypeController
import one.ztd.workbench.web.workitem.WorkItemPropertyController
import one.ztd.workbench.web.workitem.WorkItemStatusController
import one.ztd.workbench.web.workitem.WorkItemTypeConfigController
import one.ztd.workbench.web.workitem.WorkflowController
