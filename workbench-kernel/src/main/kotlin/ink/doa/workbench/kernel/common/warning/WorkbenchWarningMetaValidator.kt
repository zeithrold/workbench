...
import ink.doa.workbench.kernel.common.warning.meta.ApiVersionDeprecatedMeta
...
import ink.doa.workbench.kernel.common.warning.meta.TenantWarningEmbed
...
object WorkbenchWarningMetaValidator {
  ...
  private fun validateProjectEmbed(project: ProjectWarningEmbed) {
  ...
  private fun validateTenantEmbed(tenant: TenantWarningEmbed) {
