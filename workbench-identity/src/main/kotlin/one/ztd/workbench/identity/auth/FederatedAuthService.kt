...
private data class OAuthCallbackContext(
  val loginState: one.ztd.workbench.identity.model.AuthLoginStateRecord,
  val methodRecord: one.ztd.workbench.identity.model.LoginMethodDefinitionRecord,
  val setting: one.ztd.workbench.identity.model.TenantLoginMethodSettingRecord,
)
