...
import kotlinx.serialization.json.jsonObject
import one.ztd.workbench.identity.auth.OAuthFederatedClient
...
@Component
class DefaultOAuthFederatedClient(private val secretResolver: SecretResolver) :
  OAuthFederatedClient {
  private val json = Json { ignoreUnknownKeys = true }
  private val http = HttpClient.newHttpClient()

  override fun pkceChallenge(verifier: String): String {
    val digest =
