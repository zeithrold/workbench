package ink.doa.workbench.service
...
private const val SERVICE_PACKAGE = "package ink.doa.workbench.service"

private fun serviceSourceFiles(): List<Path> =
  Files.walk(workbenchServiceDir().resolve("src/main/kotlin/ink/doa/workbench/service")).use { paths
    ->
...
private fun String.isForbiddenServiceDependency(): Boolean {
  ...
  return trimmed.startsWith("import ink.doa.workbench.data.") ||
    ...
    trimmed == "import ink.doa.workbench.core.identity.LoginAccountStore" ||
