...
import ink.doa.workbench.application.instance.support.UnusedPublicIdResolverDependencies
import ink.doa.workbench.application.invitation.InvitationCollaborators
import ink.doa.workbench.application.invitation.InvitationIdentitySupport
import ink.doa.workbench.application.invitation.InvitationService
import ink.doa.workbench.application.permission.AdminUserPersistenceSupport
  ...
  StringSpec({
    ...
    beforeSpec {
        ...
        InvitationService(
          identity =
            InvitationIdentitySupport(
              ...
              users = users,
              login =
                ink.doa.workbench.application.invitation.InvitationLoginSupport(
                  loginMethods,
                  loginAccounts,
                  userLoginAccounts,
                  passwordHasher,
      ...
      runBlocking {
        val bootstrapUser =
          users.create(
            ink.doa.workbench.identity.model.CreateUserCommand(
