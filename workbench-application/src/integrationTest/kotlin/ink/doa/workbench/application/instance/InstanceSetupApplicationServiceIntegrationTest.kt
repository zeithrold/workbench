...
import ink.doa.workbench.identity.auth.AuthCredentialSupport
...
import ink.doa.workbench.identity.auth.LoginOrchestrator
...
import ink.doa.workbench.identity.auth.SessionCredentialService
...
class InstanceSetupApplicationServiceIntegrationTest :
  StringSpec({
    ...
    "bootstrap rejects second initialization" {
      shouldThrow<ink.doa.workbench.kernel.common.errors.InstanceAlreadyInitializedException> {
        runBlocking {
          service.bootstrap(
            BootstrapInstanceAdminCommand(
              displayName = "Other",
...
private fun passwordVerifier(
  ...
  object : ink.doa.workbench.identity.auth.PasswordVerifier {
