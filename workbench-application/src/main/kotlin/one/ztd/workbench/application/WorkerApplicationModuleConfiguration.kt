...
@ComponentScan(
  basePackages = ["one.ztd.workbench.application.jobs"],
  excludeFilters =
    [ComponentScan.Filter(type = FilterType.CUSTOM, classes = [TypeExcludeFilter::class])],
)
@EnableConfigurationProperties(MessagingProperties::class, InstanceProperties::class)
@Import(
  AgileModuleConfiguration::class,
  NotificationModuleConfiguration::class,
  TenantModuleConfiguration::class,
)
class WorkerApplicationModuleConfiguration
