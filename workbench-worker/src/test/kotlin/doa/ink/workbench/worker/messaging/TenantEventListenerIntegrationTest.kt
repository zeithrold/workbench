...
import doa.ink.workbench.service.messaging.support.KafkaTestSupport
import doa.ink.workbench.service.messaging.support.MessagingIntegrationFixtures
...
class TenantEventListenerIntegrationTest :
  StringSpec({
    ...
    val destroyHandler =
      DomainEventHandler<doa.ink.workbench.core.tenant.events.TenantDestroyRequestedEvent> {}
    val pipeline =
      ConsumerPipeline(
        decoder = decoder,
