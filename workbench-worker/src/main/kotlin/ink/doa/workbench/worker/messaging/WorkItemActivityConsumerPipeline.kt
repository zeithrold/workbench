...
@Component
class WorkItemActivityConsumerPipeline(
  private val decoder: DomainEventDecoder,
  private val router: WorkItemActivityEventRouter,
) {
  ...
  fun run(record: ConsumerRecord<String, String>) {
    runBlocking {
      ...
      try {
        ...
        logger.info(
          "work_item_activity_event_consumed topic={} partition={} offset={} type={} eventId={} durationMs={}",
          record.topic(),
          record.partition(),
          record.offset(),
          envelope.type,
        ...
        logger.error(
          "work_item_activity_event_decode_failed topic={} partition={} offset={} durationMs={}",
          record.topic(),
          record.partition(),
          record.offset(),
          elapsedMillis(started),
